...
echo "$FRONTEND_URL"
echo "-----------------------------------------"
echo "⚠️  IMPORTANTE PARA GITHUB CODESPACES ⚠️"
echo "Antes de probar la subida de imágenes, asegurate"
echo "para cambiar la visibilidad de los puertos 80 y 4566"
echo "a 'Public' en la pestaña 'Ports' de VS Code."
echo "========================================="
